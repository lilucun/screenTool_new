...
void HuaWei8_0_DUK_AL20::themeInstall()
{
    ...
    // 我的
    clickScreen(953, 142, 800);
    // 上滑动
    swipeScreen(838, 1933, 838, 500, 1000);
    //
    clickScreen(523, 1300, 1000);
    // 应用
    clickScreen(517, 2094,3000);

    // 不保留 锁屏杂志
    clickScreen(289, 2021, 2000);
    // home
    returnHome();
}
...
void HuaWei8_0_DUK_AL20::contactsGroup()
{
    ...
    // 数字
    clickScreen(982, 2080, 500);
    // 666
    clickScreen(779, 1746, 100);
    clickScreen(790, 1739, 100);
    clickScreen(780, 1746, 500);
...
void HuaWei8_0_DUK_AL20::messageWebsit(){
    ...
    //swipeScreen(296, 2009, 289, 2009, 500);
    //第一条短信
    clickScreen(424, 796, 500);
    // 输入框
    clickScreen(424, 2081, 500);
...
//    clickScreen(994, 2094, 100);
//    clickScreen(293, 1599, 100);
//    clickScreen(556, 1796, 100);
//    clickScreen(556, 1796, 100);
//    clickScreen(770, 1612, 100);
//    clickScreen(770, 1612, 100);
//    clickScreen(490, 1802, 100);
//    clickScreen(263, 1602, 100);
//    clickScreen(523, 1596, 100);
//    clickScreen(566, 1717, 100);
//    clickScreen(543, 2084, 500);
...
void HuaWei8_0_DUK_AL20::messageSend()
{
    ...
    // 输入happy
    inputText("HAPPY");
//    clickScreen(530, 1334, 500);
//    clickScreen(658, 1648, 500);
//    clickScreen(75, 1622, 500);
//    clickScreen(1030, 1514, 500);
//    clickScreen(1030, 1514, 500);
//    clickScreen(586, 1478, 500);
//    clickScreen(948, 1937, 500);
//    clickScreen(352, 1320, 500);
    ...
    // 清除输入
    clickScreen(368, 1987, 500);
    clickScreen(986, 1546, 400);
    clickScreen(986, 1546, 400);
    clickScreen(986, 1546, 400);
    clickScreen(986, 1546, 400);
    clickScreen(986, 1546, 400);
