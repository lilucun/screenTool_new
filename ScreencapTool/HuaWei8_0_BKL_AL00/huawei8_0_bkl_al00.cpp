#include "huawei8_0_bkl_al00.h"
#include <QTextCodec>
#include "imagecompare.h"
#include <QPluginLoader>
#include <QDebug>
HuaWei8_0_BKL_AL00::HuaWei8_0_BKL_AL00()
{
    QTextCodec *codec = QTextCodec::codecForName("utf-8");
    QTextCodec::setCodecForLocale(codec);
}

HuaWei8_0_BKL_AL00::HuaWei8_0_BKL_AL00(const QString &menufest, const QString &iSerial):ScreenTool(menufest, iSerial)
{

}

void HuaWei8_0_BKL_AL00::totalCutPicture(const QVector<int> &)
{

}

void HuaWei8_0_BKL_AL00::taskIdSwitch(int i)
{
    switch (i) {
    case ContactsList:
        contactsList();
...
void HuaWei8_0_BKL_AL00::themeInstall()
{
    // 返回home
    returnHome();
    // 关闭导航栏
...
//    swipeScreen(838, 1933, 838, 500, 1000);
    ...
    clickScreen(551, 2076, 1000);

    //returnBack(1000);
    clickScreen(76, 120, 1000);// 返回
...
void HuaWei8_0_BKL_AL00::contactCutImage()
{
    contactsList();
    contactsImpExp();
    contactsSetting();
...
void HuaWei8_0_BKL_AL00::digitCutImage()
{
    dialDial();
    dialMore();
    dialDetail();
...
void HuaWei8_0_BKL_AL00::homeCutImage()
{
    homeHome();
    homeFolder();
    homeList();
...
void HuaWei8_0_BKL_AL00::messageCutImage()
{
    messageList();
    messageWebsit();
    messageSetting();
...
void HuaWei8_0_BKL_AL00::pushThemeToPhone(const QString &themeFile)
{
    // 删除旧的themes
    QString str;
...
// 单手键盘关闭检查
void HuaWei8_0_BKL_AL00::recoverEnv()
{
    returnHome();
...
bool HuaWei8_0_BKL_AL00::keyBoardIsDown(const QString &img)
{
    QString basePath(picPath);
...
//**********************************************
// contacts
void HuaWei8_0_BKL_AL00::contactsList()
{
    returnHome();
...
void HuaWei8_0_BKL_AL00::contactsImpExp()
{
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启主题
...
void HuaWei8_0_BKL_AL00::contactsSetting()
{
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启主题
...
void HuaWei8_0_BKL_AL00::contactsGroup()
{
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启主题
...
void HuaWei8_0_BKL_AL00::contactsLinkedIn()
{
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启主题
...
void HuaWei8_0_BKL_AL00::contactsNew()
{
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启主题
...
void HuaWei8_0_BKL_AL00::dialDial()
{
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启主题
...
void HuaWei8_0_BKL_AL00::dialMore()
{
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启主题
...
void HuaWei8_0_BKL_AL00::dialDetail()
{
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启主题
...
void HuaWei8_0_BKL_AL00::dialSave()
{
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启主题
...
void HuaWei8_0_BKL_AL00::dialKeybord()
{
    returnHome();
    returnHome();
    clickScreen(79, 2110, 100);
...
void HuaWei8_0_BKL_AL00::dialMark()
{
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启主题
...
void HuaWei8_0_BKL_AL00::homeHome()
{
    returnHome();
    returnHome();
    clickScreen(79, 2110, 100);
...
void HuaWei8_0_BKL_AL00::homeFolder()
{
    returnHome();
    returnHome();
    clickScreen(79, 2110, 100);
...
void HuaWei8_0_BKL_AL00::homeList()
{
    returnHome();
    returnHome();
    clickScreen(79, 2110, 100);
...
void HuaWei8_0_BKL_AL00::homeSetting(){
    returnHome();
    returnHome();
    clickScreen(79, 2110, 100);
...
void HuaWei8_0_BKL_AL00::homeMenu(){
    returnHome();
...
void HuaWei8_0_BKL_AL00::homeLock(){
    returnHome();
    returnHome();
    clickScreen(79, 2110, 100);
...
void HuaWei8_0_BKL_AL00::homeVolume(){
    returnHome();
...
void HuaWei8_0_BKL_AL00::homeNetwork()
{
    returnHome();
    clickScreen(79, 2110, 100);
    ...
    swipeScreen(707, 32, 599, 1225, 500);
    // 移动网络.png
    clickLongTime(562, 250, 800);
    cutAnImage("home", "移动网络.png", 100);

    returnHome();
}

void HuaWei8_0_BKL_AL00::homePower()
{
    returnHome();
    clickScreen(79, 2110, 100);
    // 下滑屏幕
...
void HuaWei8_0_BKL_AL00::homeSimpleMode()
{
    returnHome();
    returnHome();
    clickScreen(79, 2110, 100);
...
void HuaWei8_0_BKL_AL00::messageList(){
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启短信
...
void HuaWei8_0_BKL_AL00::messageWebsit(){
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启短信
    restartActvity("com.android.mms/.ui.ConversationList");
...
void HuaWei8_0_BKL_AL00::messageSetting(){
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启短信
    restartActvity("com.android.mms/.ui.ConversationList");
...
void HuaWei8_0_BKL_AL00::messagePress(){
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启短信
    restartActvity("com.android.mms/.ui.ConversationList");
    ...
    clickScreen(424, 416, 500);
    // 长按
    clickLongTime(752, 1320, 1000);
    cutAnImage("message", "长按短信-2.png", 100);

    returnHome();
}
void HuaWei8_0_BKL_AL00::messageNew(){
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启短信
    restartActvity("com.android.mms/.ui.ConversationList");
...
void HuaWei8_0_BKL_AL00::messageSearch(){
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启短信
    restartActvity("com.android.mms/.ui.ConversationList");
...
void HuaWei8_0_BKL_AL00::messageCollection(){
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启短信
    restartActvity("com.android.mms/.ui.ConversationList");
...
void HuaWei8_0_BKL_AL00::messageNotice(){
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启短信
    restartActvity("com.android.mms/.ui.ConversationList");
...
void HuaWei8_0_BKL_AL00::messageRailway(){
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启短信
    restartActvity("com.android.mms/.ui.ConversationList");
...
void HuaWei8_0_BKL_AL00::messageReports(){
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启短信
    restartActvity("com.android.mms/.ui.ConversationList");
    ...
    clickScreen(424, 416, 500);
    // 长按
    clickLongTime(752, 1317, 1000);
    // 小的更多
    clickScreen(875, 1130, 500);
    // 大的更多
...
void HuaWei8_0_BKL_AL00::messageNavbar()
{
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启短信
...
void HuaWei8_0_BKL_AL00::messageSend()
{
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启短信
