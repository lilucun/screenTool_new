...
void HuaWeiPhones9::contactsNew()
{
    ...
    //1.19 16.50 add begin
    //adbSystem->clickScreen(KEYBORDPOS_X/*996*/, KEYBORDPOS_Y/*1439*/, 500);// 关闭键盘

    adbSystem->clickScreen(240, 813, 500, NO_CONV_POS);
    adbSystem->inputText("666");
    adbSystem->delayMS(300);
    ...
    // 空白
    adbSystem->clickScreen(800, 1800, 500);
    short changPox = 145;
    // 加入群组
    adbSystem->clickScreen(558, C_NEW_ADDGROUP_Y+changPox/*1357*/, 500, NO_CONV_POS);
    //
    ...
    // 添加更多
    adbSystem->clickScreen(217, C_NEW_ADDMORE_Y+changPox/*1552*/, 500, NO_CONV_POS);
    // add end
...
void HuaWeiPhones9::homeWallpaper9_1()
{
    ...
    // 图片
    adbSystem->clickScreen(850, 548, 1000);
    //670 2154
...
void HuaWeiPhones9::messageEmoticon9_1()
{
    ...
    // 9.20 add begin
    // 表情笑脸
    adbSystem->clickScreen(201, 1547, 500);
    // 截图
...
void HuaWeiPhones9::messageCollection()
{
    ...
    adbSystem->restartActvity("com.android.mms/.ui.ConversationList");
    // ...
    adbSystem->clickScreen(1012, 147, 500, NO_CONV_POS);
    // 我的收藏
    adbSystem->clickScreen(800, 431, 500, NO_CONV_POS);
    // 截图
