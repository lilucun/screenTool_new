...
HuaWei9_1_HMA_AL00::HuaWei9_1_HMA_AL00()
{

}

HuaWei9_1_HMA_AL00::HuaWei9_1_HMA_AL00(const QString &menufest, const QString &iSerial):ScreenTool(menufest, iSerial)
{
    //initFunList9_1();
    //log = new MyLog("HuaWei9_1_HMA_AL00.txt");
}
...
// 初始化函数map
void HuaWei9_1_HMA_AL00::initFunList9_1()
{
    //contactsGroup;
...
void HuaWei9_1_HMA_AL00::taskIdSwitch(int i)
{
    switch (i) {
...
void HuaWei9_1_HMA_AL00::pushThemeToPhone(const QString &themeFile)
{
    // 删除旧的themes
    QString str;
...
void HuaWei9_1_HMA_AL00::themeInstall()
{
    // 返回home
    returnHome();
    // 关闭导航栏
    ...
    // 修改字体
    clickScreen(297, 855, 500);
    //
    clickScreen(357, 710, 500);

    clickScreen(560, 2175, 800);

    clickScreen(90, 148, 800);

    // 我的主题
    clickScreen(297, 705, 1000);
    //
    ...
    // 点击批量删除
    clickScreen(835, 572, 500);
    // 全选
    clickScreen(616, 2149, 500);
    // 删除
    clickScreen(440, 2146, 500);
    // 确定
    clickScreen(816, 2098, 500);

    returnHome();
    returnHome();
    // 恢复
    clickScreen(955, 1670, 6000);
//    restartActvity("com.weining.view.activity/com.weining.backup.ui.activity.HomeActivity");
    clickScreen(910, 1024, 800);
    // 导入
    clickScreen(798, 156, 800);
    //
    clickScreen(478, 582, 800);
    //
    clickScreen(784, 367, 800);
    //
    clickScreen(888, 1330, 800);

    returnHome();
    swipeScreen(500, 2243, 500, 1900, 800);
    clickScreen(777, 2165, 800);
    clickScreen(557, 1986, 800);
...
/********************************************************************/
// 联系人列表
void HuaWei9_1_HMA_AL00::contactsList()
{
    // 返回home
    returnHome();
    // 关闭导航栏
...
void HuaWei9_1_HMA_AL00::contactsImpExp()
{
    // 返回home
    returnHome();
    // 关闭导航栏
...
void HuaWei9_1_HMA_AL00::contactsSetting()
{
    // 返回home
    returnHome();
    // 关闭导航栏
...
void HuaWei9_1_HMA_AL00::contactsGroup()
{
    // 返回home
    returnHome();
    // 关闭导航栏
...
void HuaWei9_1_HMA_AL00::contactsLinkedIn()
{
    // 返回home
    returnHome();
    // 关闭导航栏
...
void HuaWei9_1_HMA_AL00::contactsNew()
{
    // 返回home
    returnHome();
    // 关闭导航栏
    ...
    // 上滑动
    swipeScreen(716, 1000, 716, 600, 500);
    // 加入群组
    clickScreen(558, 1117, 500);
    //
    cutAnImage("contacts", "新建-新建联系人-加入群组.png", 100);
    // 取消
    clickScreen(113, 151, 500);

    // 添加更多
    clickScreen(217, 1502, 500);
    // 上滑动
    swipeScreen(716, 1000, 716, 400, 500);

    // 日期
    clickScreen(628, 1986, 500);
    // 截图
...
void HuaWei9_1_HMA_AL00::dialDial()
{
    // 返回home
    returnHome();
    // 关闭导航栏
...
void HuaWei9_1_HMA_AL00::dialMore()
{
    // 返回home
    returnHome();
    // 关闭导航栏
...
void HuaWei9_1_HMA_AL00::dialDetail()
{
    // 返回home
    returnHome();
    // 关闭导航栏
...
void HuaWei9_1_HMA_AL00::dialSave()
{
    // 返回home
    returnHome();
    // 关闭导航栏
...
void HuaWei9_1_HMA_AL00::dialCollect9_1()
{
    // 返回home
    returnHome();
    // 关闭导航栏
...
void HuaWei9_1_HMA_AL00::homeHome()
{
    // 返回home
    returnHome();
    returnHome();
    ...
    // 右滑
    swipeScreen(470, 1704, 200, 1704, 500);
    swipeScreen(470, 1704, 200, 1704, 500);
...
void HuaWei9_1_HMA_AL00::homeFolder()
{
    // 返回home
    returnHome();
    returnHome();
    ...
    //截屏
    swipeHalfCutImage(858, 1154, 658, 1154, "home", "文件夹-4.png");
    // 左边滑动
    swipeScreen(858, 1154, 255, 1154, 500);
    // +
    clickScreen(296, 1244, 500);
    // 截屏
    clickCancelCutImage(298, 2085, 3000, "home", "文件夹添加.png");
    // 返回home
    returnHome();
}

void HuaWei9_1_HMA_AL00::homeList()
{
    // 返回home
    returnHome();
    // 关闭导航栏
...
void HuaWei9_1_HMA_AL00::homeSetting()
{
    // 返回home
    returnHome();
    // 关闭导航栏
...
void HuaWei9_1_HMA_AL00::homeMenu()
{
    // 返回home
    returnHome();
    // 关闭导航栏
...
void HuaWei9_1_HMA_AL00::homeLock()
{
    // 返回home
    returnHome();
    // 关闭导航栏
    ...
    // 左边滑动3次
    swipeScreen(741, 2083, 300, 2083, 300);
    swipeScreen(741, 2083, 300, 2083, 300);
    swipeScreen(741, 2083, 300, 2083, 300);
    // 截图
...
void HuaWei9_1_HMA_AL00::homeVolume()
{
    // 返回home
    returnHome();
    // 关闭导航栏
...
void HuaWei9_1_HMA_AL00::homeWallpaper9_1()
{
    // 返回home
    returnHome();
    // 关闭导航栏
...
void HuaWei9_1_HMA_AL00::messageEmoticon9_1()
{
    // 返回home
    returnHome();
    // 关闭导航栏
...
void HuaWei9_1_HMA_AL00::messageCentre9_1()
{ // 返回home
    returnHome();
    // 关闭导航栏
    clickScreen(131, 2185, 500);
...
void HuaWei9_1_HMA_AL00::messageList()
{
    // 返回home
    returnHome();
    // 关闭导航栏
    ...
    // 截图2
    swipeScreen(660, 1350, 660, 900, 500);
...
void HuaWei9_1_HMA_AL00::messageWebsit()
{
    // 返回home
    returnHome();
    // 关闭导航栏
...
void HuaWei9_1_HMA_AL00::messageSetting()
{
    // 返回home
    returnHome();
    // 关闭导航栏
...
void HuaWei9_1_HMA_AL00::messagePress()
{
    // 返回home
    returnHome();
    // 关闭导航栏
...
void HuaWei9_1_HMA_AL00::messageNew()
{
    // 返回home
    returnHome();
    // 关闭导航栏
...
void HuaWei9_1_HMA_AL00::messageSearch()
{
    // 返回home
    returnHome();
    // 关闭导航栏
...
void HuaWei9_1_HMA_AL00::messageCollection()
{
    // 返回home
    returnHome();
    // 关闭导航栏
...
void HuaWei9_1_HMA_AL00::messageNotice()
{
    // 返回home
    returnHome();
    // 关闭导航栏
...
void HuaWei9_1_HMA_AL00::messageRailway()
{
    // 返回home
    returnHome();
    // 关闭导航栏
...
void HuaWei9_1_HMA_AL00::messageReports()
{
    // 返回home
    returnHome();
    // 关闭导航栏
