...
HuaWei8_0_BLA_TL00::HuaWei8_0_BLA_TL00()
{
    QTextCodec *codec = QTextCodec::codecForName("utf-8");
    QTextCodec::setCodecForLocale(codec);
}

HuaWei8_0_BLA_TL00::HuaWei8_0_BLA_TL00(const QString &menufest, const QString &iSerial):ScreenTool(menufest, iSerial)
{

}

void HuaWei8_0_BLA_TL00::totalCutPicture(const QVector<int> &)
{

}

void HuaWei8_0_BLA_TL00::taskIdSwitch(int i)
{
    switch (i) {
    case ContactsList:
        contactsList();
...
void HuaWei8_0_BLA_TL00::themeInstall()
{
    // 返回home
    returnHome();
    // 关闭导航栏
    ...
    delayMS(1000);
    // 我的
    clickScreen(944, 143, 1000);
//    // 上滑动
    swipeScreen(838, 1933, 838, 500, 500);
//  // 我的主题
    clickScreen(564, 1313, 1000);
    // 选中主题
   // clickScreen(226, 660, 1000);
    ...
    // 不保留 锁屏杂志
    clickScreen(294, 2021, 2000);
    // home
    returnHome();
}


void HuaWei8_0_BLA_TL00::contactCutImage()
{
    contactsList();
    contactsImpExp();
    contactsSetting();
...
void HuaWei8_0_BLA_TL00::digitCutImage()
{
    dialDial();
    dialMore();
    dialDetail();
...
void HuaWei8_0_BLA_TL00::homeCutImage()
{
    homeHome();
    homeFolder();
    homeList();
...
void HuaWei8_0_BLA_TL00::messageCutImage()
{
    messageList();
    messageWebsit();
    messageSetting();
...
void HuaWei8_0_BLA_TL00::pushThemeToPhone(const QString &themeFile)
{
    // 删除旧的themes
    QString str;
...
//**********************************************
// contacts
void HuaWei8_0_BLA_TL00::contactsList()
{
    returnHome();
...
void HuaWei8_0_BLA_TL00::contactsImpExp()
{
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启主题
...
void HuaWei8_0_BLA_TL00::contactsSetting()
{
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启主题
...
void HuaWei8_0_BLA_TL00::contactsGroup()
{
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启主题
    ...
    clickCancelCutImage(328, 1163, 3000, "contacts", "群组-新建.png");
...
void HuaWei8_0_BLA_TL00::contactsLinkedIn()
{
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启主题
...
void HuaWei8_0_BLA_TL00::contactsNew() //bug
{
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启主题
    ...
    // 666
//    clickScreen(805, 1759, 100);
//    clickScreen(805, 1758, 100);
//    clickScreen(819, 1757, 500);
    inputText("666");
    ...
    // 添加其他项
    clickScreen(557, 1166, 500);
    // 生日
    clickScreen(458, 1469, 500);
    // 截取
    cutAnImage("contacts", "新建-新建联系人-添加更多项-日期", 100);
...
void HuaWei8_0_BLA_TL00::dialDial()
{
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启主题
...
void HuaWei8_0_BLA_TL00::dialMore()
{
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启主题
    ...
    // 来电拒接短信
    clickScreen(701, 1647, 500);
    cutAnImage("digit", "更多设置-来电拒接短信.png", 100);


    returnHome();
}
void HuaWei8_0_BLA_TL00::dialDetail()
{
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启主题
...
void HuaWei8_0_BLA_TL00::dialSave()
{
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启主题
...
void HuaWei8_0_BLA_TL00::dialKeybord()
{
    returnHome();
    clickScreen(79, 2110, 100);
...
void HuaWei8_0_BLA_TL00::dialMark()
{
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启主题
...
void HuaWei8_0_BLA_TL00::homeHome()
{
    returnHome();
    returnHome();
    clickScreen(79, 2110, 100);
    ...
    // 左滑屏幕
    swipeScreen(839, 986, 329, 960, 100);
...
void HuaWei8_0_BLA_TL00::homeFolder()
{
    returnHome();
    returnHome();
    clickScreen(79, 2110, 100);
...
void HuaWei8_0_BLA_TL00::homeList()
{
    returnHome();
    returnHome();
    clickScreen(79, 2110, 100);
...
void HuaWei8_0_BLA_TL00::homeSetting(){
    returnHome();
    returnHome();
    clickScreen(79, 2110, 100);
...
void HuaWei8_0_BLA_TL00::homeMenu(){
    returnHome();
    returnHome();
    clickScreen(79, 2110, 100);
...
void HuaWei8_0_BLA_TL00::homeLock()//bug
{
    returnHome();
    returnHome();
    clickScreen(79, 2110, 100);
...
void HuaWei8_0_BLA_TL00::homeVolume(){
    returnHome();
...
void HuaWei8_0_BLA_TL00::homeNetwork()
{
    returnHome();
    clickScreen(79, 2110, 100);
...
void HuaWei8_0_BLA_TL00::homePower()//bug 把超级省电放到对应位置
{
    returnHome();
    clickScreen(79, 2110, 100);
    // 下滑屏幕
...
void HuaWei8_0_BLA_TL00::homeSimpleMode()
{
    returnHome();
    returnHome();
    clickScreen(79, 2110, 100);
...
void HuaWei8_0_BLA_TL00::messageList(){
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启短信
...
void HuaWei8_0_BLA_TL00::messageWebsit(){
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启短信
    restartActvity("com.android.mms/.ui.ConversationList");
...
void HuaWei8_0_BLA_TL00::messageSetting(){
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启短信
    restartActvity("com.android.mms/.ui.ConversationList");
...
void HuaWei8_0_BLA_TL00::messagePress(){
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启短信
    restartActvity("com.android.mms/.ui.ConversationList");
...
void HuaWei8_0_BLA_TL00::messageNew(){
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启短信
    restartActvity("com.android.mms/.ui.ConversationList");
...
void HuaWei8_0_BLA_TL00::messageSearch(){
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启短信
    restartActvity("com.android.mms/.ui.ConversationList");
...
void HuaWei8_0_BLA_TL00::messageCollection(){
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启短信
    restartActvity("com.android.mms/.ui.ConversationList");
...
void HuaWei8_0_BLA_TL00::messageNotice(){
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启短信
    restartActvity("com.android.mms/.ui.ConversationList");
...
void HuaWei8_0_BLA_TL00::messageRailway(){
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启短信
    restartActvity("com.android.mms/.ui.ConversationList");
...
void HuaWei8_0_BLA_TL00::messageReports(){
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启短信
    restartActvity("com.android.mms/.ui.ConversationList");
...
void HuaWei8_0_BLA_TL00::messageNavbar()
{
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启短信
...
void HuaWei8_0_BLA_TL00::messageSend()
{
    returnHome();
    clickScreen(79, 2110, 100);
    // 重启短信
